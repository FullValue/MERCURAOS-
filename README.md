...
2. Créer une période datée dans le registre. Renseigner le prix du liquide par parfum. Saisir **séparément pour 2 ml et 50 ml** les composants (flacon, packaging, etc.), leurs coûts HT/TTC et quantités, ainsi que le coût fixe et variable de façonnage et la quantité de lot de chaque format. Ajouter ensuite le taux de perte, la livraison, les coûts variables fournisseur et la TVA récupérable. Aucun de ces coûts n'a été inventé dans le seed.
